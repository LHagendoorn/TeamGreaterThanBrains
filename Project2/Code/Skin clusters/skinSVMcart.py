...
feat = pd.read_csv('/home/ml0902/skinTrainFeatures.csv', index_col = 0)
...
with open('/home/ml0902/SKINclassifierpolytrainset_SVC_c01.pkl', 'wb') as f:
    pickle.dump(clf, f)
...
predsdf.to_pickle('/home/ml0902/predictions_SKIN_poly_c01_validationset.pkl')  # where to save it, usually as a .pkl

#predsdf = pd.read_pickle('predictions_testdata__onevsone_padded_linearSVC_rs5.pkl')
#Write outputfile
check = predsdf
predsdf = check
Output.to_outputfile(check,1,'/home/ml0902/SKINpoly_c01_clean_validationset',clean=True, validation=True)
Output.to_outputfile(check,2,'/home/ml0902/SKINpoly_c01_validationset',clean=False, validation=True)