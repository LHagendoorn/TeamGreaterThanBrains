...
#get filenames
testdata_filenames = load_testdata_filenames()
...
print df2.head()
df2.to_csv('testdata_caffefeatures.csv', index=False, header=False) #save to csv
