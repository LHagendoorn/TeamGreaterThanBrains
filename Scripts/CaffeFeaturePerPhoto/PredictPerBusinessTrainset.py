...
It does this for all businesses in the trainset.
...
LabelsForPhotosVal=pd.read_csv('C:/Users/roosv_000/Documents/pred_trainOfTrainSet_trainedOnTrainOfTrain.csv', sep=',')
